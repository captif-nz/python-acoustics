...
class Signal(np.ndarray):
    ...
    def peak(self, axis=-1):
        ...
        """
        return acoustics.standards.iso_tr_25417_2007.peak_sound_pressure(
            self, axis=axis
        )
    ...
    def peak_level(self, axis=-1):
        ...
        """
        return acoustics.standards.iso_tr_25417_2007.peak_sound_pressure_level(
            self, axis=axis
        )
    ...
    def max_level(self, axis=-1):
        ...
        """
        return acoustics.standards.iso_tr_25417_2007.max_sound_pressure_level(
            self, axis=axis
        )
    ...
    def sound_exposure(self, axis=-1):
        ...
        """
        return acoustics.standards.iso_tr_25417_2007.sound_exposure(
    ...
    def sound_exposure_level(self, axis=-1):
        ...
        """
        return acoustics.standards.iso_tr_25417_2007.sound_exposure_level(
            self, self.fs, axis=axis
        )
    ...
    def levels(self, time=0.125, method="average"):
        ...
        """
        if method == "average":
            return acoustics.standards.iec_61672_1_2013.time_averaged_sound_level(
                self.values, self.fs, time
            )
        elif method == "weighting":
            return acoustics.standards.iec_61672_1_2013.time_weighted_sound_level(
                self.values, self.fs, time
            )
        else:
    ...
    def leq(self):
        ...
        """
        return acoustics.standards.iso_tr_25417_2007.equivalent_sound_pressure_level(
            self.values
        )
