...
class OctaveBand(Frequencies):
    ...
    def __init__(
        ...
        if center is not None:
            ...
            indices = acoustics.octave.index_of_frequency(
                center, fraction=fraction, ref=reference
            )
        elif fstart is not None and fstop is not None:
            nstart = acoustics.octave.index_of_frequency(
                fstart, fraction=fraction, ref=reference
            )
            nstop = acoustics.octave.index_of_frequency(
        ...
        center = acoustics.octave.exact_center_frequency(
